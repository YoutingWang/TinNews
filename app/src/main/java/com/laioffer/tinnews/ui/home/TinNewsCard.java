...
public class TinNewsCard {
    ...
    private final OnSwipeListener onSwipListener;

    public TinNewsCard(Article news, OnSwipeListener onSwipListener) {
    ...
    private void onSwipedOut() {
        ...
        onSwipListener.onDisLike(article);
    }
